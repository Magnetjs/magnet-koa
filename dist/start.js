...
class KoaStart extends _base2.default {
  setup() {
    var _this = this;

    return _asyncToGenerator(function* () {
      try {
        _this.koaConfig = Object.assign(_koa2.default, _this.config.koa, _this.options);

        if (_this.koaConfig.port) {
          _this.app.server = _this.app.application.listen(_this.koaConfig.port);
          _this.log.info(`Server started at port ${_this.koaConfig.port}`);
        }
      } catch (err) {
        _this.log.error(err);
        throw err;
