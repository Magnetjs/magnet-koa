...
class KoaMagnet extends _base2.default {
  setup() {
    var _this = this;

    return _asyncToGenerator(function* () {
      _this.koaConfig = Object.assign(_koa4.default, _this.config.koa, _this.options);
      // Setup Koa
      _this.app.application = new _koa2.default();
      _this.app.application.on('error', function (err) {
